    ...
    return (
        <div className="w-full max-w-xl bg-card text-card-foreground border border-gray-300/20 rounded-xl p-6 space-y-6">
            ...
            <div className="space-y-2">
                ...
                <p className="text-lg text-gray-300">@recluta</p>
            </div>
            <div className="space-y-2">
                <h3 className="font-semibold mb-0 text-gray-400">Email </h3>
                <p className="text-lg text-gray-300">recluta@gmail.com</p>
            </div>
            <div className="space-y-2">
                <h3 className="font-semibold mb-0 text-gray-400">Bio </h3>
                <p className="text-lg italic text-gray-300">Nessuna bio aggiunta.
                    <a href="#" className="px-1 underline-offset-4 hover:underline text-blue-500">
                        Aggiungine una!
                    </a>
                </p>
            </div>
            ...
            <div className="flex flex-col gap-3">
                ...
                <Button className="w-full rounded-3xl bg-rose-800 hover:bg-rose-900 border border-gray-300/30">
                    <svg xmlns="http://www.w3.org/2000/svg" width="24" height="24" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round" className="lucide lucide-log-out h-5 w-5" aria-hidden="true"><path d="m16 17 5-5-5-5"></path><path d="M21 12H9"></path><path d="M9 21H5a2 2 0 0 1-2-2V5a2 2 0 0 1 2-2h4"></path>
                    </svg>Esci dall'account
                </Button>
            </div>
        </div>
    );
